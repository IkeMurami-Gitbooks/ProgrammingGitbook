...
[IndexedDB API](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB\_API) (иногда сокращают до IDB) это полная база данных, доступная в браузере, в которой вы можете хранить сложные связанные данные, типы которых не ограничиваются простыми значениями, такими как строки или числа.
