...
`ngx-permissions` — управление разрешениями на уровне модулей ангуляра (можн сказать, какая группа пользователей может работать с данным модулем): [https://www.npmjs.com/package/ngx-permissions](https://www.npmjs.com/package/ngx-permissions)<br>
